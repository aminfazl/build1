...
<?php echo $this->Form->create('Lgacouncil');?>
	<fieldset>
		<legend><?php echo __('Edit Lgacouncil'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lgacouncil.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Lgacouncil.id'))); ?></li>
