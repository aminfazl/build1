<div class="matchlogs index">
	<h2><?php echo __('Matchlogs');?></h2>
	...
	<tr>
		<td><?php echo h($matchlog['Matchlog']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($matchlog['Matchlog']['startdate']); ?>&nbsp;</td>
		<td><?php echo h($matchlog['Matchlog']['enddate']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($matchlog['Employee']['id'], array('controller' => 'employees', 'action' => 'view', $matchlog['Employee']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $matchlog['Matchlog']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $matchlog['Matchlog']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $matchlog['Matchlog']['id']), null, __('Are you sure you want to delete # %s?', $matchlog['Matchlog']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
