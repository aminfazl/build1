<div class="prioritylevels view">
<h2><?php  echo __('Prioritylevel');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($prioritylevel['Prioritylevel']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Prioritylevel Name'); ?></dt>
		<dd>
			<?php echo h($prioritylevel['Prioritylevel']['prioritylevel_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Prioritylevel'), array('action' => 'edit', $prioritylevel['Prioritylevel']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Prioritylevel'), array('action' => 'delete', $prioritylevel['Prioritylevel']['id']), null, __('Are you sure you want to delete # %s?', $prioritylevel['Prioritylevel']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($prioritylevel['Client'])):?>
	...
	<?php
		$i = 0;
		foreach ($prioritylevel['Client'] as $client): ?>
		<tr>
