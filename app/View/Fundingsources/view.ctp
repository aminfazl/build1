<div class="fundingsources view">
<h2><?php  echo __('Fundingsource');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($fundingsource['Fundingsource']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Fundingsource Name'); ?></dt>
		<dd>
			<?php echo h($fundingsource['Fundingsource']['fundingsource_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Fundingsource'), array('action' => 'edit', $fundingsource['Fundingsource']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Fundingsource'), array('action' => 'delete', $fundingsource['Fundingsource']['id']), null, __('Are you sure you want to delete # %s?', $fundingsource['Fundingsource']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($fundingsource['Client'])):?>
	...
	<?php
		$i = 0;
		foreach ($fundingsource['Client'] as $client): ?>
		<tr>
