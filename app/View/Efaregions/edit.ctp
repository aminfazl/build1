...
<?php echo $this->Form->create('Efaregion');?>
	<fieldset>
		<legend><?php echo __('Edit Efaregion'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Efaregion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Efaregion.id'))); ?></li>
